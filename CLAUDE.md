...
# provider_uri 代码硬编码 ~/.qlib/qlib_data/cn_data，通过软链指向 /home/zxh/qlib_data（见 §6.1 Qlib 数据软链）
...
# Qlib 数据可用性（qlib 在 Docker 内，主 env 不装；用 0.8 env 核对软链路径）
# 注意：验证用 ~/.qlib/qlib_data/cn_data（代码硬编码的实际路径，经软链指向 /home/zxh/qlib_data）
